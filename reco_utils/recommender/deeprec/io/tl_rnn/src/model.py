...
from reco_utils.recommender.deeprec.io.tl_rnn.src.config import OPTIMIZER, EPOCHS, SEQUENCE_LEN_MAX, \
...
class tlrnn():
    ...
    def train(self, run_name=None, tensor_train=None, alpha=None):
        ...
        self.model_train.fit(
            ...
            verbose=1)
        self.model_train.save_weights('./logs/' + run_name + '/final_weights.h5')
