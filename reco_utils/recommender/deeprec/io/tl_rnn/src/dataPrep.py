...
import random
from reco_utils.recommender.deeprec.io.tl_rnn.src.config import BATCHES_PER_USER, BATCH_SIZE, COV_NUMBER, SEQUENCE_LEN_MAX, COVARIATES_ALL, COVARIATES_TO_TRANSLATE, \
